...
function bsespana_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['bsespana_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('bsespana Theme Settings'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
  ...
  $form['bsespana_settings']['general_settings']['theme_color_config']['theme_color_palette'] = array(
    '#type' => 'select',
 ...
 $form['bsespana_settings']['general_settings']['bsespana_boxed'] = array(
    '#type' => 'checkbox',
    '#title' => t('Boxed Layout?'),
    '#default_value' => theme_get_setting('bsespana_boxed', 'bsespana'),
    '#description' => t("Check for yes!"),
  );
  
  $form['bsespana_settings']['general_settings']['theme_pattern_config']['theme_bg_pattern'] = array(
    '#type' => 'select',

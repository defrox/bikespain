...
?>
<a class="experiencia-link" href="<?php print file_create_url($language->language . '/' . $contexto . drupal_get_path_alias('node/' . $row->nid, $row->node_language));?>?iframe=true&width=100%&height=100%" rel="prettyPhoto[iframes]" node="<?php print $row->nid;?>">

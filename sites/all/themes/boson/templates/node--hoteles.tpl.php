...
if (!empty($node->field_estrellas)) {
	...
	for ($i=1; $i <= 5; $i++) { 
		if ($i > $stars) {
			print '<div class="star" style="background: url(/sites/all/modules/fivestar/widgets/bikespain/start.jpg) no-repeat 0 -4px; width: 21px; height:30px; float:left"></div>';
		}
		else{
			print '<div class="star" style="background: url(/sites/all/modules/fivestar/widgets/bikespain/start.jpg) no-repeat 0 -52px; width: 21px; height:30px; float:left"></div>';
		}
	}
	print '</div></center>';

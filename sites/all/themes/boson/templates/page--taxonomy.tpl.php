...
<div class="content shortcodes">
 ...
 <?php if (!$page['sidebar_first']): ?>
    ...
    <?php endif; ?>
		...
		$my_arg = $term->name;
		print '<div class="taxonomy-description">';
        print $term->description;
        print '</div>';
        print '</br>';
        if ($term->vocabulary_machine_name == 'destinos'){print '<h3 class="lined" style="margin-top: 12px">'.t('Tours in ').' '.$my_arg.'</h3>';}
        if ($term->vocabulary_machine_name == 'tipo_producto'){print '<h3 class="lined" style="margin-top: 12px">'.t('Tours by type: ').' '.$my_arg.'</h3>';}
         ?>

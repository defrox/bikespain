...
function maquetaCajaRelacionados(&$out, &$tiposProductos, &$prod, &$i, &$titulo, $tipo=0){
	...
	if (0==(strcmp ($tipo_producto, 'A tu aire'))){
		$tipo_ruta_producto = "trip/tu-aire";
	}
	elseif (0==(strcmp ($tipo_producto, 'Guiados'))){
		$tipo_ruta_producto = "trip/guiados";
	}
	elseif(0==(strcmp ($tipo_producto, 'Barco y bicicleta'))){
		$tipo_ruta_producto = "trip/barco-y-Bicicleta";
	}
	elseif(0==(strcmp ($tipo_producto, 'En familia'))){
		$tipo_ruta_producto = "trip/familia";
	}
	...
	$out .= '<div class="resultados_tipo_contenido" href="'.$url.'">'. $texto_promocional .'</div>';

...
function bseurope_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['bseurope_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('bseurope Theme Settings'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
  ...
  $form['bseurope_settings']['general_settings']['theme_color_config']['theme_color_palette'] = array(
    '#type' => 'select',
 ...
 $form['bseurope_settings']['general_settings']['bseurope_boxed'] = array(
    '#type' => 'checkbox',
    '#title' => t('Boxed Layout?'),
    '#default_value' => theme_get_setting('bseurope_boxed', 'bseurope'),
    '#description' => t("Check for yes!"),
  );
  
  $form['bseurope_settings']['general_settings']['theme_pattern_config']['theme_bg_pattern'] = array(
    '#type' => 'select',
